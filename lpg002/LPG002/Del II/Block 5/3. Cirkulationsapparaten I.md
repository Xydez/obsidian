...
> I skelettmuskler: "Troponin flyttar på tropomyosin och då blottas akin-site:en".

Ca2+ binder till CaM (calmodulin) som simmar runt i cytoplasma, ofta i närheten av de kontraktila proteinerna

CaM aktiverar därvidlag enzymet MLCK (myosin light chain kinase)
...
Alltså, kontraktionsgraden beror på balansen mellan aktivitet i MLCK och MLCP. När Ca2+ stiger ökar MLCK-aktiviteten och börjar dominera.
...
> Har man en styv aorta kan mötet ske nära hjärtat, vilket gör att hjärtat får svårt att ömma sig.
...
**Dilation**
Vidgning (vasodilation) erfordrar *hämning* av myogen tonus.
...
**Konstriktion**
Konstriktion erfordrar *facilitering* av myogen tonus.
...
- lokalt
	...
	- reducerat flöde
	- färre metaboliter
	- lokala vasokonstriktorer (t.ex. endotelin, tomboxan)
- centralt
...
Appropå P(O2) misstänker man att erytrocyter känner av syrgasnivån och bildar NO som påverkar kärltonus (se slide).
...
> PGI2 gav nobellpris, NO gav nobellpris; såklart att folk är intresserade av EDHF. Men det kanske också är så att det bara är direkt kommunikation mellan endotel- och glattmuskelceller via gap junctions.
