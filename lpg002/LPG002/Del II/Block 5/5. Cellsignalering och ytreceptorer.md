...
Produceras av arginin och aktiverar guanynylcyklasproteiner för att aktivera sekond second messengers genom att GTP blir till cGMP.
...
I princip alla är gjorda från kolesterol, binder till kärnreceptorfamiljen.

**Exempel: glukokortikoid**
Finns i ett bärarprotein, när den kommer nära cellen släpper den sin bärare. I normalfallet hänger glukokortikoidreceptorn ihop med ett HSP (heat shock protein) som skyddar den från nedbrytning. Glukokortikoid har en så hög affinitet att den alstrar en konformationsändring som gör att HSP släpper;

vi får då en receptor-receptordimerisering, alltså att två receptorer binder samman (händer med många receptorer, men inte de G-kopplade)
...
En agonist binder till utsidan och alstrar en konformationsändring. En pytteliten intracellulär del tillåter då de heterotrimeriska (alfa-beta-gamma-subenheter) G-proteinern att inbinda.

Alfasubenheten frisätter då GDP varvid GTP binder in istället, därvidlag har vi erhållit ett aktivt komplex. Alfa-GTP-laddade subenheten frikopplas och gör något, medan beta-gamma-subenheten gör något annat.
...
Inneboende hydrolys i alfa-subenheten, då mister den sin aktivitet och letar åter reda på en beta-gamma-subenhet för att stabilisera varandra (återvinns).
...
Liganden binder till en receptor, vi får *alltid* en dimerisering av receptorn.
...
> "Ruskigt bra tentafråga": vad är det för skillnad mellan kinaser och G-proteinkopplad aktivering. ELLER ÄR DET GTP-bindning?????

**Första:**
När receptorn blir aktiv kan den fosforylera protein 1, som fosforylerar protein 2, som fosforylerar protein 3 och ger en nedströms signalering (scaffold protein - det är receptorn som binder alla tre proteinerna samtidigt)
...
**Andra:**
När receptorn är aktiv fosforylerar den något, varvid proteinet binder in.

**Tredje:**
Fosfoinositide docking site (fosfoinositol-lipider kan bli fosforyleras och kan göra att det går nedstöms)
...
Ett kinas blir fosforylerat av sig självt. De fosforylerade tyrosinerna blir då bindningsplatser för proteiner.

Alltid SH2-bindande domäner, som binder fosforylerade tyrosiner när receptorerna är fosforylerade. Alltså man får en bindningssite för fosfotyrosin och en bindningssite för peptidkedjan.
