...
Ju längre utåt i cellen, desto tjockare blir membranet (p.g.a. längre fettsyresvansar/acylgrupper och mer kolesterol). Tätare packning.
...
### Kanalfogar
Kanalfogar (gap junctions) består av konnexinringar (består av två connexon) finns på vardera cell och sammanfogar för att binda ihop två cellers cytoplasma.
...
Kanalfogar är inte alltid öppna, utan stängs då $\ce{[Ca2+]}$ eller $\ce{[H+]}$ går upp (kalcium är tecken på apoptos, försurning är tecken på cellskada).
...
Förlopp:
1. Substrat binder i cytoplasman, vilket leder till en konformationsändring
