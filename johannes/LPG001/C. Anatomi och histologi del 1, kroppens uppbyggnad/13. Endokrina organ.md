...
- pars intermedia (en mellandel mot lobus posterior, innehåller folliklar med kolloid, ett karakteristikum, ser ut som ett par färgblobbar)
	- Kommer från Rathke's ficka?? eller något sånt
...
### Tallkottskörteln
Tallkottskörteln (corpus pineale), även *epifysen*, är en körtel som sitter posteriort.
...
Pinealocyter, som producerar melatonin. Finns även gliaceller, som är lite mer avlånga bleka. Också, många kapillärer.
### Sköldkörteln
...
Finns också celler med något triangelformade kärnor, som hänger på utsidan av folliklarna. Dessa är parafollikulära celler (C-celler). Dessa sänker $\ce{Ca^2+}$ i blodbanan.

Även bindväv här och där (m. fibroblaster), samt enstaka immunceller.

> Var produceras kalcitonin???
